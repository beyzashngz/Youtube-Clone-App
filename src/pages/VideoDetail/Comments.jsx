    ...
    <div className="my-6">
      ...
      {data.data.map((i,key) => (
        <div key={key} className="flex gap-2 items-start px-1 py-4">
          <img className="w-10 h-10 rounded-full" src={i.authorThumbnail[0].url} alt="logo" />
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-5 items-center">
                <div className="flex gap-1 p-1 rounded cursor-pointer hover:bg-gray-300 items-center" > <AiOutlineLike /> {i.likesCount} </div>
                <div className="p-1 rounded cursor-pointer hover:bg-gray-300"> <AiOutlineDislike /> </div>
                <button className="p-1 rounded cursor-pointer hover:bg-gray-300">Yanıtla</button>
            </div>
