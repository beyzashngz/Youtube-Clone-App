...
const VideoCard = ({video, isRow}) => {
    ...
    //veri tipi video değilsen bileşen hiçbir şey render etmesin
  ...
  return (
    ...
    className={`${isRow ? 'row' : ''} cursor-pointer`}>
      ...
      <div className="">
        <img src={
            isHover && video.richThumbnail ? video?.richThumbnail[0].url: video.thumbnail[video.thumbnail.length-1].url
      ...
      <div className="flex gap-4 mt-5 ">
        ...
        <div>
            ...
            <div className="flex gap-3">
                ...
                * <p className="whitespace-nowrap text-[14px]">{video.publishedTimeText}</p>
            </div>
        </div>
      </div>
    </div>
